...
* Fix bug in member of pointer operator for bucket iterators in the closed-addressing
  containers (credit goes to Github user vslashg for finding and fixing this issue).
